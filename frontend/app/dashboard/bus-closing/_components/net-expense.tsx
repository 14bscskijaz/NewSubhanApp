...
const NetExpenses = ({ tripRevenue, TotalExpense }: TripRevenueT) => {
    ...
    return (
        <div className='font-bold grid grid-cols-2 text-sm w-72 place-self-end mt-2'>
            ...
            <div className='border-x border-t bg-gradient-border px-2 py-1  '>{formatAmount(tripRevenue)} </div>
            <div className='border-x border-b bg-gradient-border px-2 py-1'>Route Expense </div>
            <div className='border-x border-b bg-gradient-border px-2 py-1 '>{formatAmount(TotalExpense || 0)} </div>
            ...
            <div className='border bg-gradient-border px-2 py-1 rounded-br-md text-base'>
                {formatAmount(Number(tripRevenue) - Number(TotalExpense))}
            </div>
        </div>
    );
}
