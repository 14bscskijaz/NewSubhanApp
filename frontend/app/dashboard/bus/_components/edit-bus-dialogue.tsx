...
export default function EditBusDialog({
  ...
  const [busBrand, setBrand] = useState(bus.busBrand || "");
      ...
      <DialogContent className="sm:max-w-[940px] max-h-[570px] overflow-y-auto custom-scrollbar">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-10 py-4 md:grid-cols-2">
            ...
            <div className="grid gap-2">
              <Label htmlFor="busBrand" className="text-gradient">Brand</Label>
              <Input
                id="busBrand"
                value={busBrand}
                onChange={(e) => setBrand(e.target.value)}
                placeholder="Enter busBrand"
                required
                aria-describedby="busBrand-error"
              />
            </div>
            <div className="grid gap-2">
