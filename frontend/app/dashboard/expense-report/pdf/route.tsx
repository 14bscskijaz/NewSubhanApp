...
import { ExpenseReport, getExpenseReports } from "@/app/actions/expenses.action";
...
const GeneratePdf = ({ 
  ...
  const title = aggregate === 'route' ? 'Expense Report (By Route)' : 'Expense Report';
...
export async function GET(request: NextRequest) {
  ...
  console.log("Query Params for PDF:", queryParams);
    try {
    const response: ActionResponse<ExpenseReport> = await getExpenseReports(queryParams);
